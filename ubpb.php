...
require_once plugin_dir_path( __FILE__ ) . 'admin/class-ubpb-pattern-manager.php';
require_once plugin_dir_path( __FILE__ ) . 'admin/class-ubpb-pattern-library.php';
require_once plugin_dir_path( __FILE__ ) . 'admin/class-ubpb-ai-builder.php';

// Define plugin constants
define( 'UBPB_VERSION', '1.0.2' );
...
function upbp_register_post_type() {
	$pattern_args = [
		...
		'labels'              => [
			...
			'all_items'             => __( 'Your All Patterns',                   'ultimate-blocks-pattern-builder' ),
